...
public final class AuthConfig {
    ...
    static {
        ...
        LANGUAGE = builder.comment("Message language: auto (client language), ru, en or zh")
    ...
    public static int minPasswordLength() { return minPasswordLength; }
    public static int maxLoginAttempts() { return maxLoginAttempts; }
    public static int lockoutSeconds() { return lockoutSeconds; }
